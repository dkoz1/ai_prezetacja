...
These methods are effective to use when there is collinearity in your input values and ordinary least squares would overfit the training data.
	    ...
	    Adding Ridge penalty:
	   	\begin{equation}
	    minimize(E+\lambda \sum_{j=1}^{p}\beta_{j}^{2})
	    \end{equation}	
	   	\begin{figure}[h]
		...
		To find $\lambda$ we can also perform CV. Example:
		\begin{figure}[h]
		\includegraphics[scale=0.3]{images/cvRidge.png}
		\end{figure}
		In this case Ridge is not providing imrovements. What about Lasso?
	   	 }
	   	 
	   	 \frame[allowframebreaks]{
	   	 \frametitle{9.Regularization}
	    \framesubtitle{Lasso Regression}
	    Lasso allow to get rid of some parameters. 
	   	\begin{equation}
	    E=1/n * \sum_{i=0}^{n}(y_{i}-\beta_{1}*x_{i}+\beta_{0})
	    \end{equation}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%	   %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\frame{
		...
		\item General equation
			\begin{equation}
				y = \beta_{0} + \beta_{1}*x_{i} + \beta_{2}*x_{i}^2 + \beta_{3}*x_{i}^3 + ... + \beta_{m}*x_{i}^m + E, i=1,2,3...
			\end{equation}
